#WarningJannganDiUbahAuthorNyaBangek😄
...
for apa in range(10000):
	...
	cih1 = str(rc([f"Mozilla/5.0 (Linux; Android 6.0.1; SAMSUNG SM-G532G Build/MMB29T) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/4.2 Chrome/44.0.2403.133 Mobile Safari/537.36"]))
	cih2 = str(rc([f"Mozilla/5.0 (Linux; Android 5.0.2; SAMSUNG SM-A500FU Build/LRX22G) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/3.3 Chrome/38.0.2125.102 Mobile Safari/537.36"]))
	cih3 = str(rc([f"Mozilla/5.0 (Linux; Android 6.0.1; SAMSUNG SM-G930T1 Build/MMB29M) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/4.0 Chrome/44.0.2403.133 Mobile Safari/537.36"]))
	cih4 = str(rc([f"Mozilla/5.0 (Linux; Android 6.0.1; SAMSUNG SM-G532G Build/MMB29T) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/4.2 Chrome/44.0.2403.133 Mobile Safari/537.36"]))
	cih5 = str(rc([f"Mozilla/5.0 (Linux; Android 5.1.1; SAMSUNG SM-A9000 Build/LMY47V) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/4.0 Chrome/44.0.2403.133 Mobile Safari/537.36"]))
	cih6 = str(rc([f"Mozilla/5.0 (Linux; Android 6.0.1; SM-N910V Build/MMB29M) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/52.0.2743.98 Mobile Safari/537.36"]))
	cih7 = str(rc([f"Mozilla/5.0 (Linux; Android 5.0; SAMSUNG SM-N900V 4G Build/LRX21V) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/2.1 Chrome/34.0.1847.76 Mobile Safari/537.36"]))
	cih8 = str(rc([f"Mozilla/5.0 (Linux; Android 6.0.1; SAMSUNG SM-N920T Build/MMB29K) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/4.0 Chrome/44.0.2403.133 Mobile Safari/537.36"]))
	JansXD = random.choice([cih,cih1,cih2,cih3,cih4,cih5,cih6,cih6,cih8])
	ugen.append(JansXD)
P = '\x1b[1;97m'
M = '\x1b[1;91m'
H = '\x1b[1;92m'
...
\x1b[1;97m─────────────────────────
\x1b[1;97mHemkerTermos : Jans XD 
\x1b[1;97mNo Whatsap : 083841160198
\x1b[1;97mFacebook : facebook.com/JepangID
''')

def banlog():
   print('''\33[1;96m  
   _______  ____________  ____  ____  __ __
  / __/ _ |/ ___/ __/ _ )/ __ \/ __ \/ //_/         
 / _// __ / /__/ _// _  / /_/ / /_/ / ,<    	 
/_/ /_/ |_\___/___/____/\____/\____/_/|_| 
\x1b[1;97mRhochod JANS XD
No Whatsap 083841160198 
\x1b[1;91mTOOLS GFF V0.0.1                       ''')
...
def login_men():
    try:
        ...
        print('─────────────────────────────')
        your_cookies=input(f'masukan cookie [>>] :{xxx}{hijo} ')
...
def menu(id):
	...
	banner()
	print(f'{xxx}─────────────────────────────')
	os.system("xdg-open https://wa.me/+6283841160198?text=Assalamualaikum+makasih+bang+sc+nya+moga+ijo🙄")
	print(f'{xxx}[>>] 1. crack')
	helpbas = input(f'{xxx}[>>] : ')
	if helpbas in ['1']:
		nge_krek()
...
def atur_dulu():
	...
	print(f'[>>] 1. JANDA [{h}TUA{x}]')
	print(f'[>>] 2. PERAWAN [{h}MUDA{x}]')
	print(f'[>>] 3. JANDA PIRANG [{h}ACAK{x}]')
	aturid = input(f'{xxx}[>>] : ')
	if aturid in ['1','01']:
	...
	print(f'{h}VALIDATE     {u}ASYNC    {b}REGULER\n{h}1 m.fb{x}V1    {u}3 m.fb{x}A1  {b}4 m.fb{x}RE\n{h}2 m.fb{x}V2{xxx}')
	metod = input(f'{xxx}[>>] : ')
	if metod in ['1','01']:
		baz.append('free')
	elif metod in ['2','02']:
...
def cektahun(fx):
	if len(fx)==15:
		...
		elif fx[:5] in ['10001']           :tahunz = '2017'
		elif fx[:5] in ['10002']           :tahunz = '2018'
		elif fx[:5] in ['10003']           :tahunz = '2019'
		elif fx[:5] in ['10004']           :tahunz = '2020'
